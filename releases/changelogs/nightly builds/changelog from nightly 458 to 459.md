# Updated AE2FluidCraft-Rework (1.2.28-gtnh@Side.BOTH --> 1.3.0-gtnh@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/AE2FluidCraft-Rework/compare/1.2.28-gtnh...1.3.0-gtnh
>## What's Changed
...
# Updated Angelica (1.0.0-alpha40@Side.CLIENT --> 1.0.0-alpha42@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Angelica/compare/1.0.0-alpha40...1.0.0-alpha42
>## What's Changed
...
# Updated Applied-Energistics-2-Unofficial (rv3-beta-352-GTNH@Side.BOTH --> rv3-beta-400-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Applied-Energistics-2-Unofficial/compare/rv3-beta-352-GTNH...rv3-beta-400-GTNH
>## What's Changed
...
# Updated Battlegear2 (1.3.7@Side.BOTH --> 1.4.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Battlegear2/compare/1.4.0...1.4.0
>## What's Changed
> * fix NPE for Ultramine server by @TimeConqueror in https://github.com/GTNewHorizons/Battlegear2/pull/28 (1.4.0)
>

# Updated BetterQuesting (3.5.13-GTNH@Side.BOTH --> 3.6.0-GTNH@Side.BOTH)
...
# Updated BloodMagic (1.5.2@Side.BOTH --> 1.6.0@Side.BOTH)
...
# Updated Computronics (1.7.2-GTNH@Side.BOTH --> 1.8.0-GTNH@Side.BOTH)
...
# Updated EnderStorage (1.5.1@Side.BOTH --> 1.6.0@Side.BOTH)
...
# Updated ForestryMC (4.8.9@Side.BOTH --> 4.9.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ForestryMC/compare/4.8.9...4.9.0
>## What's Changed
> * NEI incorrect tooltip with search by @slprime in https://github.com/GTNewHorizons/ForestryMC/pull/69 (4.9.0)
>

# Updated GT5-Unofficial (5.09.45.163@Side.BOTH --> 5.09.46.01-pre@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GT5-Unofficial/compare/5.09.45.163...5.09.46.01-pre
>## What's Changed
> * GT recipe.cfg cleanup by @chochem in https://github.com/GTNewHorizons/GT5-Unofficial/pull/2579 (5.09.46.00)
>

# Updated GTplusplus (1.11.58@Side.BOTH --> 1.12.3-pre@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTplusplus/compare/1.11.58...1.12.3-pre
>## What's Changed
...
# Updated GoodGenerator (0.8.22@Side.BOTH --> 0.9.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GoodGenerator/compare/0.8.22...0.9.0
>## What's Changed
> * Fix Essentia Input Hatch by @MeiTianyou in https://github.com/GTNewHorizons/GoodGenerator/pull/254 (0.9.0)
> * Deduplicate assline recipes for yottank cells by @NotAPenguin0 in https://github.com/GTNewHorizons/GoodGenerator/pull/252 (0.9.0)
>

# Updated Hodgepodge (2.4.43@Side.BOTH --> 2.5.0@Side.BOTH)
...
**Full Changelog**: https://github.com/GTNewHorizons/KekzTech/compare/0.10.4...0.10.6
>## What's Changed
> * Remove " (exact)" from LSC info readout. by @AbdielKavash in https://github.com/GTNewHorizons/KekzTech/pull/88 (0.10.6)
> * Fix uuid lookup by @chochem in https://github.com/GTNewHorizons/KekzTech/pull/87 (0.10.5)
>

# Updated KubaTech (0.14.7@Side.BOTH --> 0.15.0@Side.BOTH)
...
# Updated NewHorizonsCoreMod (2.3.50@Side.BOTH --> 2.4.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NewHorizonsCoreMod/compare/2.3.50...2.4.1
>## What's Changed
...
# Updated NotEnoughEnergistics (1.5.1@Side.BOTH --> 1.6.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughEnergistics/compare/1.5.1...1.6.0
>## What's Changed
...
# Updated StructureCompat (0.5.0@Side.BOTH --> 0.6.0@Side.BOTH)
...
# Updated TecTech (5.3.45@Side.BOTH --> 5.4.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/TecTech/compare/5.3.45...5.4.0
>## What's Changed
> * Fix conflicting recipes for EOH dilation parts. by @C0bra5 in https://github.com/GTNewHorizons/TecTech/pull/280 (5.4.0)
>

# Updated ThaumicBoots (1.2.1@Side.BOTH --> 1.2.2-pre@Side.BOTH)
...
# Updated WAWLA (1.2.0-GTNH@Side.BOTH --> 1.3.0-GTNH@Side.BOTH)
...
# Updated bartworks (0.9.21@Side.BOTH --> 0.10.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/bartworks/compare/0.9.21...0.10.0
>## What's Changed
> * Add any block to void miner drops by @Lyfts in https://github.com/GTNewHorizons/bartworks/pull/7 (0.10.0)
>

# Updated nei-custom-diagram (1.5.17@Side.BOTH --> 1.5.18-pre@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/nei-custom-diagram/compare/1.5.17...1.5.18-pre
>## What's Changed
...
# Updated twilightforest (2.5.23@Side.BOTH --> 2.6.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/twilightforest/compare/2.6.0...2.6.0
>## What's Changed
> * Remove client ticker class by @Caedis in https://github.com/GTNewHorizons/twilightforest/pull/63 (2.6.0)
>

# Credits
A special thank to @AbdielKavash ,@C0bra5 ,@Caedis ,@Dyonovan ,@Ethryan ,@HfSrJun ,@HoleFish ,@Lyfts ,@MeiTianyou ,@SKProCH ,@Superfrogman98 ,@TimeConqueror ,@github-actions ,@serenibyss, who contributed to this release!