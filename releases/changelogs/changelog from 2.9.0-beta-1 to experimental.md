...
# New Mod - Foreman:0.5.1
**Full Changelog**: https://github.com/GTNewHorizons/Foreman/compare/0.5.0...0.5.1
...
>* Ignore collision for space miner by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7100 (5.09.52.605-pre)
>* [MUI2] Fixed progress bar themes registering with the wrong class by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7103 (5.09.52.605-pre)
>* Fix any Multi extending ExtendedPowerMultiBase and not overriding doRandomMaintenanceDamage not applying correct damage by @Yoshy2002 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7087 (5.09.52.605-pre)
>* Fix machine fluid output overflow, change to use long. by @Marsietiss in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7101 (5.09.52.605-pre)
>* Fix serialization implementation by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7070 (5.09.52.605-pre)
>* Make the inflection manager to support multi-level key, and add some built-in rules by @iouter in https://github.com/GTNewHorizons/GT5-Unofficial/pull/6586 (5.09.52.605-pre)
>* Fix Mixer Multi controller tooltip to use correct casing name by @Steelux8 in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7115 (5.09.52.605-pre)
>* [MUI2] Port MTEFusionComputer by @AnsonYeung in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7095 (5.09.52.605-pre)
>* Scanner sends translation keys instead of pre-translated strings by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7090 (5.09.52.605-pre)
>* [MUI2] Better Gui Slot Filtering by @TheYoingLad in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7116 (5.09.52.605-pre)
>* Implemented the Terrasteel/Terrestrial Enhancement Augment by @Spaghetti-OberNub in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7122 (5.09.52.605-pre)
>* Defer getInfoData() translation to client for Nuclear Control compatibility by @Eldrinn-Elantey in https://github.com/GTNewHorizons/GT5-Unofficial/pull/7105 (5.09.52.605-pre)
